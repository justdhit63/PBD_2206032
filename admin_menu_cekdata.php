...
<body>
    ...
    <div class="data_tagihan">
        <table>
            ...
            <tbody>
                    ...
                    include "koneksi.php";
                    $no=1;
                    $ambildata = mysqli_query($koneksi,"select * from data_tagihan");
                    while ($tampil = mysqli_fetch_array($ambildata)){
                        ...
                        <tr>
                            ...
                            <th class='action_button_del'><a href='?kode=$tampil[no_sl]'> Delete </a></th>
                            <th class='action_button_up'><a href='admin_menu_update.php?kode=$tampil[no_sl]'> Update </a></th>
                        </tr>";
                    ...
                    if(isset($_GET['kode'])){
                        if(mysqli_query($koneksi,"delete from data_tagihan where no_sl='$_GET[kode]'")){
                            ...
                            echo "<meta http-equiv-refresh content=2;URL='admin_menu_cekdata.php'>"; 
                        }
                        else{
    ...
    <div class="kembali"><a href="admin_menu_history.php" class="tbl-biru">History</a></div>
