...
<?php
include "koneksi.php";
$sql=mysqli_query($koneksi,"select * from petugas where id_petugas='$_GET[kode]'");
...
<head>
    ...
    <title>Admin Update Petugas</title>
    ...
    <div class="tambah_data">
        <form action="" method="post">
            <fieldset class="form-set">
                <label> No SL </label>
                <div>
                    <input type="text" name="id_petugas" value="<?php echo $data['id_petugas']; ?>" readonly>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="alamat_petugas" value="<?php echo $data['alamat_petugas']; ?>">
                </div>
            </fieldset>
